                ...
                <div className="flex items-end justify-between flex-wrap-reverse py-[50px] md:py-[100px] relative">
                    ...
                    <div className="md:max-w-[65%] flex flex-col gap-6 md:gap-10">
                        <Service
                            ...
                            desc="As an expert in Vanilla JS and React JS, I have extensive knowledge and proficiency in both technologies. Vanilla JS refers to pure JavaScript, while React JS is a popular library for building efficient and reusable UI components."
                            data={[
                                "Prototype",
                                "Wireframe",
                                "User Experience",
                        ...
                        <Service
                            num="2"
                            title="Express, MongoDB, JWT, Firebass"
                            desc="As an expert in Express, MongoDB, JWT, and Firebase, I possess a deep understanding of these technologies. Express is a flexible web application framework, MongoDB is a NoSQL database, JWT is a secure authentication mechanism, and Firebase provides a comprehensive suite of cloud-based tools for web and mobile app development."
                            data={[
                                "Prototype",
                                "Wireframe",
                                "User Experience",
                        ...
                        <Service
                            num="3"
                            title="Tailwind Responsive Expert"
                            desc="As an expert in Tailwind CSS, I have mastered the art of creating responsive web designs. Tailwind CSS is a utility-first CSS framework that offers a wide range of pre-built classes, allowing for efficient and customizable development of responsive and visually appealing user interfaces."
                            data={[
                                "Prototype",
                                "Wireframe",
                                "User Experience",
                        ...
                        <Service
                            num="4"
                            title="JS Data Structure & Algorithm"
                            desc="I possess comprehensive knowledge of JavaScript data structures and algorithms. This includes understanding various data structures such as arrays, linked lists, trees, graphs, and implementing algorithms like sorting, searching, and traversal techniques for efficient data manipulation and problem-solving in JavaScript applications."
                            data={[
                                "Prototype",
                                "Wireframe",
                                "User Experience",
