            ...
            <Wrapper>
                ...
                >
                    <div className="flex items-center gap-[6px]">
                        ...
                        <div>ss.sammo2002@gmail.com</div>  
                    </div>
                ...
                >
                    <div className="font-light mb-4">
                        👋 Hi, I Am{" "}
                        <span className="font-semibold">Sammo</span>
                    </div>
                    <div className="max-w-[510px]">
                    I am a highly skilled MERN developer with a passion for creating robust and user-friendly web applications. With 3 years of experience.
                    </div>
                </motion.div>
                {/* INTRO END */}
                ...
                >
                    ...
                    {/* START */}
                    <div className="flex items-center gap-3">
                        <div className="text-[80px] font-light">3.5+</div>
                        <div className="leading-[22px]">
                            YEARS OF
                            <br />
                            EXPERIENCE
